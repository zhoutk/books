        ...
        if line != "\n":
            ...
            if len(els) > 1:
                if els[0][-1:] == ":" and els[1][-1:] != "/" and os.path.exists("/home/zhoutk/" + els[0][:-1]):
                    ...
                    for e in els[1:]:
                        dotIndex = e.rfind(".")
                        if dotIndex > -1 and not(e[:dotIndex] == "info" or e[:dotIndex] == "pic" or e[dotIndex + 1:] == "txt" or e[dotIndex + 1:] == "jpg" or e[dotIndex + 1:] == "jpeg" or e[dotIndex + 1:] == "png" or e[dotIndex + 1:] == "gif"):
